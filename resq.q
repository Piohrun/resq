...
if[.resq.mode ~ `watch;
    ...
    / Watch owns repeated full runAll invocations in this process. runnerCmd
    / composes reporters and starts coverage immediately before each rerun, so
    / the idle watcher never holds live instrumentation wrappers.
