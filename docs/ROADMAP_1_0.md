...
- [x] Track file/function/statement eligibility, completeness, and fallback reasons.
...
- [x] Verify watch and repeated in-process runs preserve all new contracts.
- [x] Provide thin external observability adapters; keep in-process plugins
