...
defaultConfig:`fmt`outDir`describeOnly`xmlOutput`runPerformance`excludeSpecs`runSpecs`passOnly`exit`fuzzLimit`failFast`failHard`maxTestTime`reportLimit`reportListLimit!(`text;".";0b;0b;0b;();();0b;0b;100;0b;0b;0;50000;1000)
