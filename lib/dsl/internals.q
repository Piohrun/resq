...
if[not `flakeEvidenceMin in key `.tst.app; .tst.app.flakeEvidenceMin:3j];
if[not `flakeFailureMin in key `.tst.app; .tst.app.flakeFailureMin:2j];
if[not `flakeWindow in key `.tst.app; .tst.app.flakeWindow:20j];
